...
import geoData2 from '../../assets/geojson/map2.json'
        ...
        <>
            ...
            >
                <LayersControl>
                    ...
                    <LayersControl.Overlay checked name="Bantuan El Nino">
                        <GeoJSON pointToLayer={pointToLayer} data={geoData as any} />
                    </LayersControl.Overlay>
                    <LayersControl.Overlay name="Area Tanah Kosong">
                        <GeoJSON style={geoJSONStyle as any} data={geoData2 as any} />
                    </LayersControl.Overlay>
                </LayersControl>
            </MapContainer>
        </>
